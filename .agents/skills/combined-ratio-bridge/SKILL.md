...
2. **Single period:**
   ```bash
   python3 .Codex/skills/combined-ratio-bridge/scripts/combined_ratio_bridge.py \
...
3. **Period-over-period bridge** (the QoQ / YoY "what moved the combined ratio"
   ...
   echo '{"basis":"gaap",
     ...
     | python3 .Codex/skills/combined-ratio-bridge/scripts/combined_ratio_bridge.py --stdin
   ```
