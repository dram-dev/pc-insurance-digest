# pc-insurance-digest — Codex context
...
| launchd jobs loaded: `daily` 01:05 (queued behind macro's 01:00 run), `notify` 08:00, `weekly` Sat 06:00 (+ `learn` Sat 07:00 — the alpha-engine learning loop) | ✅ |
...
Pick one of these from a mobile session and Codex will have enough
...
For mobile / cloud Codex sessions, the codebase is fully working
